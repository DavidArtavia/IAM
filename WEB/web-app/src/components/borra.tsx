                  ...
                  <div className="d-flex flex-stack">
                    <div className="fw-bolder fs-4">
                      ...
                      <span className="fs-6 text-gray-400 ms-2">
                        {" "}
                        {ordenes.filter((o) => o.estado.iD_Estado === 6).length}
                      </span>
                    </div>
                  </div>
                  <div className="h-3px w-100 bg-secondary"></div>
                </div>

                {ordenes
                  .filter((m) => m.estado.iD_Estado == 6)
                  .map((m) => (
                    <div
                      className="card mb-6 mb-xl-9 flash-blue"
                    ...
                    >
                      <div className="card-body">
                        ...
                        <div className="mb-2">
                          ...
                          >
                            Orden #{m.iD_OrdenServicio}
                          </a>
                        </div>
                        <div className="fs-6 fw-bold text-gray-600 mb-5">
                          {m.referenciaJSON.map((r) => r.valor).join(", ")}
                        </div>
                        <div
                          className="separator"
                        ...
                        {items
                          .filter(
                            (i) => i.iD_OrdenServicio == m.iD_OrdenServicio
                          )
                          .map((item) => (
                            <div
                              className="mb-2"
                              key={item.iD_ItemOrdenServicio}
                            >
                        ...
                        <div
                          ...
                          style={{ marginBottom: "15px" }}
                        ></div>
                        <p className="text-gray-700 py-3 fw-bold fw-6">
                          {m.notaOrdenServicio}
                        </p>
                          ...
                          >
                            {m.estado.iD_Estado != 8 ? (
                              <div
                                ...
                                onClick={() => cambiarEstadoOrdenServicio(m, 8)}
                              >
                              ...
                              <div
                                ...
                                onClick={() => cambiarEstadoOrdenServicio(m, 7)}
                              >
                                <span className="svg-icon svg-icon-3">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="mb-9">
                  <div className="d-flex flex-stack">
                    <div className="fw-bolder fs-4">
                      En proceso
                      <span className="fs-6 text-gray-400 ms-2">
                        {ordenes.filter((o) => o.estado.iD_Estado === 7).length}
                      </span>
                    </div>
                  </div>
                    ...
                    >
                      <div className="card-body">
                        ...
                        <div className="d-flex flex-stack flex-wrapr">
                          ...
                          <div
                            className="d-flex my-1"
                            onClick={() => cambiarEstadoOrdenServicio(m, 9)}
                          >
                            <div className="border border-dashed border-gray-300 rounded py-3 px-3 text-gray-600">
                              <span className="svg-icon svg-icon-3">
                                <svg
                ...
                <div className="mb-9">
                  <div className="d-flex flex-stack">
                    <div className="fw-bolder fs-4">
                      Completado
                      <span className="fs-6 text-gray-400 ms-2">
                        {ordenes.filter((o) => o.estado.iD_Estado === 9).length}
                      </span>
                    </div>
                  </div>
                ...
                <div className="mb-9">
                  <div className="d-flex flex-stack">
                    <div className="fw-bolder fs-4">
                      En Espera
                      <span className="fs-6 text-gray-400 ms-2">
                        {ordenes.filter((o) => o.estado.iD_Estado === 8).length}
                      </span>
                    </div>
                  </div>
                ...
                >
                  <div className="table-responsive">
                    <table
                      ...
                      className="table table-row-bordered table-row-dashed gy-4 align-middle fw-bolder dataTable no-footer"
                      role="grid"
                    >
