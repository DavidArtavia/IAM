...
export const DetalleCuentaInput = ({
  ...
  useEffect(() => {
    ...
    const suma = filas.reduce(
      (acc, item) =>
        acc + parseFloat(item.valor || "0") * parseFloat(item.cantidad || "1"),
      0
    );
  ...
  const toggleDetalle = () => {
    if (enabled) {
      if (
        filas.length === 0 &&
        (descuento.valor == "0" || descuento.valor === "") &&
        (impuesto.valor == "0" || impuesto.valor === "")
      ) {
      ...
      <div className="d-flex align-items-center mb-3">
        <div className="form-check form-switch">
          <input
            ...
            id="detalleSwitch"
          />
          <label className="form-check-label fs-5" htmlFor="detalleSwitch">
            Detalle
          </label>
        </div>
      </div>
                          ...
                          <td colSpan={5} className="pb-4">
                            <div className="p-2 py-4 pb-2 pt-1 border border-secoundary rounded-3 hoverElement">
                              ...
                              <div className="row g-1">
                                <div className="col-6">
                                  <label
                                    htmlFor={"txtNombre" + idx.toString()}
                                ...
                                <div className="col-3">
                                  <label
                                    htmlFor={"txtPrecio" + idx.toString()}
                                    className="fs-7 text-gray-600"
                                  >
                                    Monto
                                  </label>
                                ...
                                <div className="col-3">
                                  <label
                                    htmlFor={"txtCantidad" + idx.toString()}
                                    className="fs-7 text-gray-600"
                                  >
                                    Cantidad
                                  </label>
