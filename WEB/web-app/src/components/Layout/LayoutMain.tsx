  ...
  const items = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          key: "3-2",
          label: <Link to="/login" onClick={handleLogout}>Cerrar Sesión</Link>,
        },
      ],
    },
    {
      key: "4",
      icon: <LogoutOutlined />,
      label: <Link to={ROUTES.LOGIN} onClick={handleLogout}>logout</Link>,
    },
  ];
const userName = "ProgDAVAA"; // Aquí puedes obtener el nombre del usuario de tu estado global o contexto
  const {
    ...
    <Layout>
      ...
      <Layout>
        ...
        >
          ...
          <div style={{ fontWeight: "bold" }}>👋 ¡Hola, {userName}!</div>
          <div>
            <img
              src={TallerLogo}
              alt="Taller Logo"
