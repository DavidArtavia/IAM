...
export const KPI = ({metrica
  ...
  useEffect(() => {
    ...
    return (
        <div className='col-xl-3 p-2' data-bs-toggle="popover"
                                    tabIndex={0}
            ...
            <div className={metrica.bgColor + " py-8 rounded-2 p-5"}>
                ...
                <span className="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                    <i className={"bi " + metrica.icono + " " + metrica.txtColor} style={{ fontSize: 'xx-large' }}></i>
                </span>
                <a className={"text-nowrap " + metrica.txtColor}>
                    {metrica.ordenTitulos === 'NR' ?
                        (
                            <>
                                <span className="form-check-label fw-bolder fs-2 lbl">{metrica.tituloNegrita} </span>
                                <span className="form-check-label fw-bold fs-6 lbl">{metrica.tituloRegular} </span>
