    ...
    <div className="card-body" id="kt_chat_messenger_body">
      ...
      >
        ...
        {messages.map((mensage) => {
          const isAudio = !!mensage.rutaAudio && !mensage.contenido;

          return (
            <div
              key={mensage.iD_Mensaje}
              ...
              >
                <div className="d-flex align-items-center mb-2">
                  ...
                  <div className="ms-3">
                    ...
                    >
                      {mensage.recibe === "IAM" ? (
                        <p className="m-0">IAM Asistente</p>
                      ) : (
                        <p className="m-0">Yo</p>
                      )}
                    </a>
                    <span className="text-muted fs-7 mb-1">
                      {dateHelpers.formatTimeDifference(mensage.fechaMensaje)}
                    </span>
                  </div>
                </div>
                <div
                  className={`p-5 rounded text-dark fw-bold mw-lg-400px${
                    mensage.recibe === "IAM"
