...
import { Login, SignUp, Verify } from "@/screens/auth";
// import { ChatAi} from "@/components";
import { RedirectIfAuth, RequireAuth, RequireVerified } from "@/utils";
...
export const AppRouter = () => {
  ...
  useEffect(() => {
    ...
    document
      .querySelectorAll<HTMLElement>(".drawer-overlay")
      .forEach((el) => el.click());
  }, [pathname]);
  ...
  return (
    <Routes>
      ...
      <Route element={<RequireAuth />}>
        {/* Ruta de verificación accesible solo si está autenticado y NO verificado */}
