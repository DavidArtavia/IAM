                            ...
                            <div className="row mt-15">
                                ...
                                <div className="col bg-light-primary px-6 py-8 rounded-2 mb-7 me-7">
                                    ...
                                    <a href="#" className="text-primary text-nowrap">
                                        ...
                                        <span className="fw-bold fs-6">(CxC-CxP)</span>

                                    </a>
                                    <div className="fw-bolder fs-1 text-primary">₡14,000</div>
                                </div>
                                <div className="col bg-light-success px-6 py-8 rounded-2 mb-7 me-7">
                                    ...
                                    <a href="#" className="text-success text-nowrap">
                                        ...
                                        <span className="fw-bold fs-6">(Comparado con período anterior)</span>
                        ...
                        <div className="card-p mt-n20 position-relative">
                            ...
                            <div className="row mt-15">
                                ...
                                <div className="col bg-secondary px-6 py-8 rounded-2 me-7 mb-7">
                                    ...
                                    <div className="fw-bolder fs-1 text-gray-800">₡15,300</div>
                                </div>                                <div className="col bg-secondary px-6 py-8 rounded-2 me-7 mb-7">
